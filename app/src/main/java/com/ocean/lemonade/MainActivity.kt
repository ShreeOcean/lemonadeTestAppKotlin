...
class MainActivity : AppCompatActivity() {
    ...
    private val SQUEEZE_COUNT = "LEMON_SIZE"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lemonImage = findViewById(R.id.iv_)
        setViewElements()
    ...
    private fun setViewElements() {
        val textAction: TextView = findViewById(R.id.textViewAction)
     ...
     */
    private fun showSanckbar(): Boolean{
